        ...
        child: Scaffold(
          ...
          body: Column(
            ...
            children: [
              ...
              CustomTextField(hintLable: "User Name", isPassword: false, textInputType: TextInputType.name),
              SizedBox(height: 10.0),
              CustomTextField(hintLable: "Email", isPassword: false, textInputType: TextInputType.emailAddress),
              SizedBox(height: 10.0),
              CustomTextField(hintLable: "Phone No", isPassword: false, textInputType: TextInputType.phone),
              SizedBox(height: 10.0),
              CustomTextField(hintLable: "Date of Birth (dd-mm-yyyy)", isPassword: false, textInputType: TextInputType.datetime),
              SizedBox(height: 10.0),
